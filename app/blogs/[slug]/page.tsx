        ...
        <article className="flex flex-col gap-4 md:gap-6 lg:gap-10">
          ...
          <div className="px-4 md:px-[50px] lg:px-[130px]">
            ...
            <div className="flex items-center gap-1  md:gap-6 lg:gap-10 py-3 border-b border-t border-[#F2F2F2]">
              ...
              {/* Social Links - Use local author's links if available */}
              <div className="flex items-center gap-3">
                {(localAuthor?.socialLinks?.linkedin || !localAuthor) && (
                  <a
                    href={localAuthor?.socialLinks?.linkedin || "https://www.linkedin.com"}
                    target="_blank"
                ...
                {(localAuthor?.socialLinks?.instagram || !localAuthor) && (
                  <a
                    href={localAuthor?.socialLinks?.instagram || "https://www.instagram.com"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#6B7280] hover:text-purple-600 transition-colors"
                ...
                {(localAuthor?.socialLinks?.youtube || !localAuthor) && (
                  <a
                    href={localAuthor?.socialLinks?.youtube || "https://www.youtube.com"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#6B7280] hover:text-purple-600 transition-colors"
                    aria-label="YouTube"
                ...
                {(localAuthor?.socialLinks?.twitter || !localAuthor) && (
                  <a
                    href={localAuthor?.socialLinks?.twitter || "https://twitter.com"}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#6B7280] hover:text-purple-600 transition-colors"
                    aria-label="Twitter"
