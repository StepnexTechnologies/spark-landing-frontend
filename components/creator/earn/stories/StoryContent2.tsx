    ...
    return (
        <div className="relative w-full h-full bg-[#212529]">
            ...
            <div className="absolute top-[18%] left-1/2 -translate-x-1/2 w-[362px] h-[595px] rounded-3xl overflow-hidden bg-gradient-to-br from-purple-900/50 to-pink-900/50">
                <Image src={"/images/creator/earn/upset-young-beautiful-businesswoman-sitting-workplace.png"} alt={"Bunny"}  width={362} height={595}/>
            </div>
            ...
            <div className="absolute top-[66%] left-1/2 -translate-x-1/2 bg-white px-3 py-1.5 rounded-xl">
                <p className="text-black text-lg font-medium text-center w-[190px] leading-tight">
                    TILL THEY BROKE YOUR HEART💔
                </p>
            </div>
