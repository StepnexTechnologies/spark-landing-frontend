...
interface StoryContent2Props {
  imageSrc?: string;
  priority?: boolean;
}

export default function StoryContent2({ imageSrc = "/images/creator/earn/story-4.png", priority = false }: StoryContent2Props) {
    ...
    return (
        <div className="relative w-full h-full ">
            ...
            {/* Bottom Navigation */}
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-full max-w-[390px] pl-2 pr-10 flex items-center gap-4">
