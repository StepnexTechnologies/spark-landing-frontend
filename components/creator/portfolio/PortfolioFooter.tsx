...
// Portfolio footer — mirror of EarnFooter but reads footer.* from the
// creatorPortfolio namespace. mb-36 clears the fixed FloatingCTA bar.
  ...
  return (
    <footer className="relative py-8 md:py-12 px-5 md:px-20 mb-36">
      ...
      >
        ...
        {/* Tablet + Desktop (≥md): compact footer */}
        <div className="hidden md:block max-w-[392px] md:max-w-[1058px] mx-auto space-y-4">
          ...
          <div className="flex flex-col items-center gap-1 text-gray-500 text-xs">
            <div className="flex flex-wrap items-center justify-center gap-1">
              ...
              <span>|</span>
              <Link href="/creator/portfolio" className="hover:text-white transition-colors">
                Creator Portfolio
              </Link>
              <span>|</span>
              <button
