        ...
        <div className="text-center relative pointer-events-none">
          ...
          >
            ...
            >
              <h2
                ref={sparkonomyRef}
                className={`text-5xl xs:text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-6 ${isPromoActive ? "" : "pt-20"} tracking-normal text-white select-none whitespace-nowrap pointer-events-none`}
                style={{
